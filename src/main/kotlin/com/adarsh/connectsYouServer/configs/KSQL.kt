...
// ClientOptions.create().setHost(ksqlServerHost).setPort(ksqlServerPort)
...
//        val streamDefinition =
//            """ AS SELECT * FROM USER_MESSAGES WHERE SENDER_USER_ID = '$userId' OR
// RECEIVER_USER_ID = '$userId';""".trimIndent()
//        return createStream(streamName, streamDefinition)
//    }
//
